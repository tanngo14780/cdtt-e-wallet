...
MFRC522 mfrc522(SDA_PIN, RST_PIN);                                 // Tạo đối tượng MFRC522
const char *ssid = "P704";
const char *password = "0366767040";                               // Mật khẩu Wi-Fi
// const char *serverUrl = "http://172.20.10.2:3002/balance/deduct";  // URL của API để trừ tiền
const char *serverUrl = "http://192.168.1.17:3002/balance/deduct";
